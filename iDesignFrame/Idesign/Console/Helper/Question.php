<?php
	...
	use Idesign\Console\Helper\Question\Question as OutputQuestion;
	use Idesign\Console\Helper\Question\Choice as ChoiceQuestion;
	use Idesign\Console\Output\Formatter\Style as OutputFormatterStyle;
	...
	class Question extends Helper {
		...
		public function ask( Input $input , Output $output , OutputQuestion $question ) {
			...
			$interviewer = function () use ( $output , $question ) {
				return call_user_func_array( array( __CLASS__ , 'doAsk' ) , array( $output , $question ) );
				//return $this->doAsk( $output , $question );
			};
