<?php
	...
	use Idesign\Process\Exception\Timeout as ProcessTimeoutException;
	use Idesign\Process\Pipes\Pipes;
	use Idesign\Process\Utils;
	use Idesign\Process\Pipes\Unix as UnixPipes;
	use Idesign\Process\Pipes\Windows as WindowsPipes;
	...
	class Process {
		...
		protected function buildCallback( $callback ) {
			...
			$callback = function ( $type , $data ) use ( $callback , $out ) {
				if ( $out == $type ) {
					call_user_func(array(__CLASS__,'addOutput'),$data);
					//$this->addOutput( $data );
				} else {
					call_user_func(array(__CLASS__,'addErrorOutput'),$data);
