<?php
	...
	use Idesign\Console\Command\Build as BuildCommand;
	use Idesign\Console\Command\Command;
	use Idesign\Console\Command\Help as HelpCommand;
	use Idesign\Console\Command\Lists as ListCommand;
	use Idesign\Console\Command\Make\Controller as MakeControllerCommand;
	use Idesign\Console\Command\Make\Model as MakeModelCommand;
	use Idesign\Console\Helper\Debug as DebugFormatterHelper;
	use Idesign\Console\Helper\Formatter as FormatterHelper;
	use Idesign\Console\Helper\Process as ProcessHelper;
	use Idesign\Console\Helper\Question as QuestionHelper;
	...
	class Console {
		...
		public function doRun( Input $input , Output $output ) {
			...
			if ( !$name ) {
				...
				$input = new Input( array( $this->defaultCommand ) );
			}
